...
* [Staging workspace registered model](https://dbc-43e330a7-c925.cloud.databricks.com/ml/models/staging-my_mlops_project-model)
* [Prod workspace registered model](https://dbc-43e330a7-c925.cloud.databricks.com/ml/models/prod-my_mlops_project-model). 
